...
<div class="wrapper">
  ...
  if (isset($_GET['status']) && $_GET['status'] == 'thanks') {
    echo "<p>Thanks for the email. I will check out your suggestion shortly!</p>";
      ...
      if(isset($error_message)) {
        ...
        echo '<p>If something is missing, let me know! Send me an email.</p>';
      }
  ?>
  <form method="post" action="suggest.php">
    <table>
      ...
      <tr>
        <th>
          <label for="title" value="<?php if(isset($title)) echo $title; ?>">Title (required)</label>            
        </th>
        <td>
        ...
        <td>
          <select name="genre" id="genre">
            ...
            <optgroup label="Music">
              ...
              <option value="Inspirational/Gospel" <?php if(isset($genre) && $genre == "Insirational/Gospel") echo ' selected'; ?>>Insirational/Gospel</option>
